  ...
  return (
    <div className={`guidelines-container ${darkMode ? "dark" : "light"}`}>
      ...
      <nav className="navbar">
        ...
        {/* CENTER: Main Title */}
        <div className="nav-title"> Intrapartum Fetal Monitoring Guidelines
      ...
      <section className="guidelines-hero">
        {/* <div className="guidelines-hero-icon">
          <FaNotesMedical />
        </div> */}

        {/* <span className="guidelines-tag">Physiology-Based CTG Support</span> */}

        {/* <h1>Intrapartum Fetal Monitoring Guidelines</h1> */}
      ...
      <section className="guideline-warning-section">
        <FaExclamationTriangle />
        <div>
          <h2>Important Clinical Disclaimer</h2>
          <p>
      ...
      <section className="guideline-section">
        <h2>Core CTG Features</h2>
        <p className="section-intro">
          CTG assessment should include baseline fetal heart rate, variability,
          accelerations, decelerations, contractions, and the overall clinical
          picture.
        </p>
        ...
        <div className="feature-grid">
          <div className="feature-box">
            ...
            <p>
              Baseline is the mean fetal heart rate over a 10-minute segment,
              excluding accelerations, decelerations, and marked variability.
            </p>
            <ul>
          ...
          <div className="feature-box">
            <h3>2. Variability</h3>
            <p>
              Variability reflects oscillations in the fetal heart rate and is
              documented in beats per minute.
            </p>
            <ul>
          ...
          <div className="feature-box">
            ...
            <p>
              Accelerations are abrupt rises in fetal heart rate above baseline.
              They usually indicate reassuring fetal response.
            </p>
            <ul>
              ...
              <li>
                If accelerations coincide with contractions, exclude maternal
                heart rate
              </li>
            </ul>
          </div>
          ...
          <div className="feature-box">
            ...
            <p>
              Decelerations are falls in fetal heart rate below baseline. They
              may represent fetal response to mechanical or hypoxic stress.
            </p>
            <ul>
          ...
          <div className="feature-box">
            ...
            <p>
              Contractions should be assessed for frequency, duration, strength,
              and resting tone between contractions.
            </p>
            <ul>
              ...
              <li>Manual palpation may be needed if CTG signal is unreliable</li>
            </ul>
          </div>
          ...
          <div className="feature-box">
            <h3>6. Cycling</h3>
            <p>
              Cycling means alternation between fetal behavioural states and is
              a reassuring sign of fetal neurological responsiveness.
            </p>
            <ul>
      ...
      <section className="guideline-section">
        ...
        <div className="method-grid">
          ...
          <div className="method-card">
            ...
            <p>
              CEFM is used when maternal or fetal risk factors are present. It
              is a screening tool for hypoxia and does not replace clinical
              observations.
            </p>
            ...
            <ul>
              ...
              <li>Encourage upright position and mobility where possible</li>
      ...
      {/* ===================== CEFM INDICATIONS ===================== */}
      <section className="guideline-section">
        <h2>When to Use Continuous Electronic Fetal Monitoring</h2>
      ...
      <section className="guideline-section">
        <h2>Step-by-Step CTG Interpretation</h2>

        <div className="steps-list">
          <div>
            <span>01</span>
            <p>
              Assess the clinical setting: gestational age, antenatal events,
              medications, previous CTG traces, and fetal growth.
            </p>
          </div>
          ...
          <div>
            <span>03</span>
            <p>
              Set the limits acceptable as normal for this specific fetus before
              assessing the trace.
            </p>
          </div>
          ...
          <div>
            <span>04</span>
            <p>
              Assess contractions, baseline heart rate, variability, cycling,
              accelerations, decelerations, and signal quality.
            </p>
          </div>
          ...
          <div>
            <span>05</span>
            <p>
              Decide whether there is no hypoxia, chronic hypoxia, gradually
              evolving hypoxia, subacute hypoxia, acute hypoxia, or uncertainty
      ...
      {/* ===================== HYPOXIA PATTERNS ===================== */}
      <section className="hypoxia-section">
        <h2>Physiology of Hypoxia in Labour</h2>
        <p className="section-intro">
          The guideline describes several patterns of fetal hypoxia during
          labour. Recognising the pattern helps guide urgency and management.
        </p>
        ...
        <div className="hypoxia-grid">
          ...
          <div className="hypoxia-card chronic">
            ...
            <p>Management: avoid further stress and expedite if necessary.</p>
          </div>
          ...
          <div className="hypoxia-card acute">
            ...
            <ul>
              ...
              <li>May be caused by cord prolapse, abruption, or uterine rupture</li>
              <li>May also follow hypotension or hyperstimulation</li>
            </ul>
            <p>Management: follow the 3-minute rule and escalate urgently.</p>
          </div>
          ...
          <div className="hypoxia-card uncertain">
            ...
            <p>
              Management: escalate, improve signal quality, and consider fetal
              scalp electrode if appropriate.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ===================== 3 MINUTE RULE ===================== */}
      <section className="guideline-section emergency-rule">
        <h2>The 3-Minute Rule for Prolonged Deceleration</h2>

        <div className="timeline">
          <div className="timeline-item">
            <span>0–3 min</span>
            <p>
              If deceleration continues for more than 3 minutes with no recovery,
              raise the emergency alarm and call the on-call team.
            </p>
          </div>
          ...
          <div className="timeline-item">
            <span>3–6 min</span>
            <p>
              Identify the cause. Check for cord prolapse, placental abruption,
              uterine rupture, maternal hypotension, or uterine hyperstimulation.
            </p>
          </div>
          ...
          <div className="timeline-item">
            ...
            <p>
              ...
              improvement in heart rate. If no recovery, prepare for immediate
              delivery.
            </p>
          </div>
          ...
          <div className="timeline-item">
            <span>9–12 min</span>
            <p>
              Deceleration should have recovered or delivery preparation should
              be in progress by the safest and quickest route.
            </p>
          </div>
          ...
          <div className="timeline-item">
            <span>12–15 min</span>
            <p>
              Aim to deliver the fetus if recovery has not occurred and urgent
      ...
      {/* ===================== REVERSIBLE ACTIONS ===================== */}
      <section className="guideline-section">
        <h2>Actions When Fetal Hypoxia is Suspected</h2>
        ...
        <div className="action-grid">
          ...
          <div>
            ...
            <p>
              Stop or reduce oxytocin. Remove prostaglandin if used. Consider
              tocolysis when hyperstimulation persists.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Sudden hypotension after epidural or spinal anaesthesia may require
              rapid fluids and anaesthetic review.
            </p>
          </div>
      ...
      <section className="guideline-section">
        <h2>Special Circumstances to Consider</h2>
        ...
        <div className="special-grid">
          <div>
            ...
            <p>
              ...
              hypoxia. A lower threshold for expedited delivery may be considered
              when meconium is present with CTG concerns.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Maternal fever increases fetal metabolic demand and may increase
              risk of hypoxia. Treat fever and infection according to clinical
              protocol.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              perfusion. Correct with position change, fluids, and anaesthetic
          ...
          <div>
            ...
            <p>
              Uterine scar rupture can present as acute hypoxia. A sudden drop
              in fetal heart rate in scarred uterus needs urgent review.
            </p>
          </div>
          ...
          <div>
            <h3>Preterm Fetus</h3>
            <p>
              Preterm CTG may show higher baseline, reduced variability, smaller
              accelerations, and less developed cycling due to immaturity.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ===================== DOCUMENTATION ===================== */}
      <section className="guideline-section">
        <h2>Documentation and Quality Checks</h2>
        ...
        <div className="documentation-list">
          ...
          <div>
            <FaClipboardList />
            <p>
              Document maternal observations, maternal pulse, blood pressure,
              temperature, and relevant intrapartum events.
            </p>
          </div>
          ...
          <div>
            <FaClipboardList />
            <p>
              If fetal heart rate is similar to maternal heart rate, confirm the
              trace is fetal and not maternal.
            </p>
          </div>
          ...
          <div>
            <FaClipboardList />
            <p>
              If signal quality is poor, escalate and consider methods to improve
